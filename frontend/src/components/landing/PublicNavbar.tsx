...
export default function PublicNavbar() {
  ...
  return (
    <header className="sticky top-0 z-[var(--z-sticky)] bg-white/95 backdrop-blur-sm border-b border-neutral-100">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8" aria-label="Global">
        ...
        <button
          type="button"
          className="lg:hidden inline-flex items-center justify-center rounded-lg p-2 text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 transition-colors"
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div ref={menuRef} className="lg:hidden border-t border-neutral-100 bg-white">
