...
const recruiterFeatures = [
  {
    ...
    description: 'Build a compelling employer brand that attracts top talent. Showcase your culture, benefits, and growth opportunities.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: 'Publish jobs',
    description: 'Create detailed job postings with skill requirements, compensation ranges, and team information. Reach candidates across channels.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'Track every application through your custom pipeline. Collaborate with your team and keep candidates informed at every stage.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'Access a pool of qualified candidates with advanced filters. Search by skills, experience, location, and availability.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'Evaluate and rank candidates with AI-assisted scoring. Collaborate with hiring managers and make faster, better decisions.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'Coordinate interview times with built-in scheduling. Send automatic reminders and collect feedback from your interview panel.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: 'Let AI handle the heavy lifting. Automated screening, candidate scoring, and job description optimization save hours every week.',
  },
];

export default function RecruiterSection() {
  return (
    <section className="py-16 sm:py-20 bg-white" id="recruiters">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-24 order-1 lg:order-2">
            <p className="text-overline text-secondary-600 mb-3">For Recruiters</p>
            ...
            <p className="mt-3 text-body-lg text-neutral-500 max-w-lg">
              JobRecruit streamlines your entire hiring pipeline. From posting roles to onboarding new hires,
              every step is optimized with AI and designed for collaboration.
            </p>
            <div className="mt-8 flex gap-3">
              <button className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-secondary-600 text-white text-sm font-medium hover:bg-secondary-700 transition-colors">
                Start Hiring
